...
export default async function NovaSessaoPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="font-display text-4xl text-primary mb-2">Nova sessão</h1>
      <p className="text-ink-muted mb-8">
        Agende um horário com um paciente em acompanhamento.
      </p>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-soft border border-primary-100/60 p-10 text-center">
      ...
      <p className="text-sm text-ink-muted mb-6 max-w-sm mx-auto">
        Você precisa ter ao menos um paciente em acompanhamento para agendar
        uma sessão.
      </p>
      <Link
        href="/pacientes/novo"
