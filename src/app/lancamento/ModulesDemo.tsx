...
const MODULES: Mod[] = [
  ...
  { id: 'transc',     name: 'Registro inteligente',   kind: 'clínico',  desc: 'A transcrição corre sozinha durante a sessão. Áudio processado e descartado em segundos.', Demo: DemoTranscricao },
  { id: 'resumos',    name: 'Memória da sessão',      kind: 'clínico',  desc: 'O resumo de cada sessão em linguagem observacional — sempre rascunho, até você revisar.', Demo: DemoResumo },
  { id: 'pront',      name: 'Linha do tempo clínica', kind: 'clínico',  desc: 'Nenhuma nota vira prontuário sem a sua leitura e assinatura. Um histórico estruturado e seu.', Demo: DemoProntuario },
