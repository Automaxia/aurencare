...
import { GasProgressoCharts } from './GasProgressoCharts'
...
export function GasManager({ objetivoId, escalas, onChange }: {
  ...
  return (
    <div style={{
      ...
      {/* Visão unificada x,y: T-Score (todas as metas) + evolução por meta */}
      <GasProgressoCharts escalas={escalas} />
...
function GasCard({ escala, onPausa, onRemover, onRegistrar }: {
  ...
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 10, padding: 14, background: 'var(--card)', opacity: escala.ativo ? 1 : 0.7 }}>
      ...
      {/* Andamentos: chips de data/nível (o gráfico unificado fica no topo) */}
